...
import { type ReactiveTextStyle, renderStyledText } from "../render.ts";
 ...
 */
export function RichText(props: RichTextProps): Node {
  const {
    spans,
    color,
    backgroundColor,
